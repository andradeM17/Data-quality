...
cleaning = ["Deduplication-study/Complete duplicates", "Deduplication-study/Near duplicates", "Deduplication-study/Triplet duplicates", "Deduplication-study"]
...
# Output CSV
csv_filename = "Deduplication-study/samples.csv"
...
with open(csv_filename, "w", newline="", encoding="utf-8-sig") as csvfile:
    ...
    for clean in cleaning:
        folder_path = clean  # assuming folder name matches cleaning type
...
print(f"CSV file '{csv_filename}' created with 180 rows")
